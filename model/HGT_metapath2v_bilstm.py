...
class HGTVulNodeClassifier(nn.Module):
    def __init__(self, compressed_global_graph_path, feature_extractor=None, node_feature='metapath2vec', hidden_size=128, num_layers=2,num_heads=8, use_norm=True, device='cpu'):
        ...
        self.bilstm = nn.LSTM(self.hidden_size, self.hidden_size,batch_first=True, bidirectional=True) 
    ...
    def forward(self, node_ids=None):
        ...
        output, (h_n, c_n) = self.bilstm(hiddens.unsqueeze(0)) 
